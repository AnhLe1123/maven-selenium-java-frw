...
public class Level_17_Share_Data_B extends BaseTest {
    ...
    public void beforeClass(String browserName) {
        ...
        log.info("Pre-condtion - Step 02: Input to Email textbox with value: " + emailAddress);
        loginPage.inputToEmailTextbox(emailAddress);

        log.info("Pre-condtion - Step 03: Input to Password textbox with value: " + password);
        loginPage.inputToPasswordTextbox(password);

        log.info("Pre-condtion - Step 04: Click to Login button");
